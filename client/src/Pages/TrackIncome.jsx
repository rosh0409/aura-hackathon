      ...
      {expense.length > 0 ? (
        <>
          <main className=" h-screen bg-greyish-ig">
            ...
            >
              <div className="w-1/4">
                <h2 className="text-center text-lg mb-6">Source</h2>
                {expense.length > 0 ? (
                  expense.map((data) => {
                    return (
                      <>
              ...
              <div className="w-1/4">
                {" "}
                <h2 className="text-center text-lg mb-6 ">Amount</h2>
                {expense.length > 0 ? (
                  expense.map((data) => {
                    return (
                      <>
        ...
        <>
          <h1 className="text-xl font-bold text-green-500">No income Found</h1>
        </>
      )}
    </section>
  );
